...
DAT.Globe = function(container, opts) {
  ...
  function init() {
    ...
    console.dir(world_jpg);
    uniforms['texture'].value = THREE.ImageUtils.loadTexture(world_jpg);
...
//  background: url('` + globe_background + `');
    ...
    render() {
      return (
        <div>
          ...
          <div id="currentInfo">
            <span id="year1990" class="year">Population</span>
            <span id="year1995" class="year">Disease</span>
            <span id="year2000" class="year">Riots</span>
          </div>
        </div>
      )
    }
